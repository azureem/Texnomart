...
_$GetProductAllCategoryDataImpl _$$GetProductAllCategoryDataImplFromJson(
    ...
    _$GetProductAllCategoryDataImpl(
      (json['products'] as List<dynamic>?)
          ?.map((e) => ProductsOmmabop.fromJson(e as Map<String, dynamic>))
          .toList(),
...
_$ProductsOmmabopImpl _$$ProductsOmmabopImplFromJson(
        Map<String, dynamic> json) =>
    _$ProductsOmmabopImpl(
...
Map<String, dynamic> _$$ProductsOmmabopImplToJson(
        _$ProductsOmmabopImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
