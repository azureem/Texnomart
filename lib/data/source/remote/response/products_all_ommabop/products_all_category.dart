...
part 'products_all_category.freezed.dart';
part 'products_all_category.g.dart';
...
@freezed
class ProductsOmmabop with _$ProductsOmmabop {
  @JsonSerializable(explicitToJson: true, fieldRename: FieldRename.snake)
  const factory ProductsOmmabop(
      int? id,
      String? name,
      String? image,
      List<SaleMonths>? saleMonths,
  ...
  factory ProductsOmmabop.fromJson(Map<String, dynamic> json) =>
      _$ProductsOmmabopFromJson(json);
}
